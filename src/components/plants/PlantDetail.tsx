...
import { ArrowLeft, Sun, Droplets, Thermometer, Clock, Leaf, Star, Heart, Share2, MessageCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      ...
      <nav className="flex items-center space-x-2 text-sm">
        <Link to="/plants" className="text-gray-500 hover:text-emerald-600 transition-colors">
          Plants
        </Link>
                ...
                <div className="space-y-4">
                  {relatedPosts.map((post) => (
                    <Link
                      ...
                      className="block border border-gray-200 rounded-lg p-6 hover:border-emerald-200 transition-colors"
                    >
